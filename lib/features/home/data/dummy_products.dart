  ...
  static List<Product> getAllProductsWithExtra() {
    return [
      ...
      Product(
        ...
        color: 'Multi',
        material: 'Leather',
        description: 'Skateboarding shoes dengan padding ekstra untuk kenyamanan dan proteksi.',
        rating: 4.8,
        verified: true,
      ),
      Product(
        ...
        color: 'Hijau',
        material: 'Suede',
        description: 'Classic terrace shoe yang terinspirasi dari budaya sepak bola Eropa.',
        rating: 4.4,
        verified: true,
      ),
      Product(
        ...
        color: 'Hitam Merah',
        material: 'Leather & Synthetic',
        description: 'Racing-inspired shoes dengan desain sporty dan aerodinamis.',
        rating: 4.7,
        verified: true,
      ),
    ];
